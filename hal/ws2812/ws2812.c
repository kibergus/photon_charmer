...
/* --- CONFIGURATION CHECK -------------------------------------------------- */
    ...
    #error WS2812 timer not specified
        ...
        #define WS2812_AF 3
    #endif
#elif !defined(WS2812_AF) && !defined(STM32F10X_MD)
...
#define PWMD(n)                             CONCAT_SYMBOLS(PWMD, n)
...
void ws2812_init(void)
{
  ...
  #ifdef STM32F10X_MD
    palSetPadMode(PORT_WS2812, PIN_WS2812, PAL_MODE_STM32_ALTERNATE_OPENDRAIN);
  #else
    ...
    dmaStreamSetMode(dma,
      STM32_DMA_CR_CHSEL(WS2812_DMA_CHANNEL) | STM32_DMA_CR_DIR_M2P | STM32_DMA_CR_PSIZE_WORD | STM32_DMA_CR_MSIZE_BYTE |
